...
/**
 * This class represents a container for available promotions that customer is entitled to redeem. Such promotions may expire if not used by the expiry date.
 * 
